        ...
        <div className="flex gap-2">
          {!comment.isApproved ? (
            <CheckCheck
              ...
              className="w-5 hover:scale-110 hover:text-green-400 transition-all cursor-pointer"
            />
          ) : (
          ...
          <Trash2
            ...
            className="w-5 hover:text-red-500 hover:scale-110 transition-all cursor-pointer"
          />
        </div>
      </td>
    </tr>
